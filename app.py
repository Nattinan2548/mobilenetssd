...
lineaccesstoken = '20j5sGhPf/yg4W8pzCaBUu7D3ftTi/4QpB9L4vEDvdI4Pc5qB6WAC25klSfFMLwg4ZbSkUFbXikHqyxXp5Um0BkIadiX1EwzFTFKTWQ1iF/R4VOwXh/Xn8W/aMbMrZSjzYbHKWJMdxAp1ANHggddoAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="สวัสดีเช่นกัน")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "สบายดีมั้ย":
            replyObj = TextSendMessage(text="สบายดี มีความสุข")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "วันนี้เป็นไงบ้าง":
            replyObj = TextSendMessage(text="ก็ดีนะแต่บางทีก็รู้สึกแย่")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/223ee6f4-5f6d-40ed-a5f7-3395765b0b82"
